...
[下载或播放 DBX SSH Workbench 87 秒真实操作演示](media/dbx-ssh-live-demo.mp4)
...
短版：`DBX SSH Workbench：把 SSH Terminal、SFTP、MCP 自动化和受控运维集中到一个工作台。`

长版：`面向日常服务器运维的 DBX SSH Workbench，打开一个连接即可完成终端、SFTP、跳板访问、
